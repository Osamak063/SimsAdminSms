...
public interface ClientAPIs {
    ...
    Call<StudentDataList> getStudents(@Query("classesID") String classId,@Query("sectionID") String sectionId,@Query("limit") int limit,@Query("offset") int offset,@Header("Authorization") String authHeader);
